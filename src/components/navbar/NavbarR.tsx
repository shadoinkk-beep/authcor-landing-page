...
const Navbar:FC = () => {
  ...
  //  window && window.addEventListener("scroll", changeNavbarColor);
    ...
    return <> 
    <header  className={`mx-auto max-w-7xl px-4 border border-black shadow-md z-50 text-black body-font fixed top-4 left-4 sm:left-6  right-4 sm:right-6 backdrop-blur-sm  rounded-xl ${pathname.split("/")[0] ==  "/" ? "dark:text-gray-400" : "bg-white/85" } ${colorChange
    ...
    <div className="container py-4 mx-auto md:flex md:justify-between items-center">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="168" height="26" viewBox="0 0 168 32" fill="none">
      ...
      <Link onClick={()=>{setisMobNavOpen(false)}} href={"/contact/quote"} className=" text-center px-6 py-2 bg-black text-white border   rounded-lg  shadow hover:bg-transparent hover:text-black hover:border-black transition">
      ...
      <Link href={"/contact/quote"} className="px-6 py-2 bg-black text-white border   rounded-lg  shadow hover:bg-transparent hover:text-black hover:border-black transition">
      <span className="relative z-10">Get a quote</span>
    </Link>
