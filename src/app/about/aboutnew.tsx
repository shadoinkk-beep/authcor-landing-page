...
<div className="z-10 grid justify-center items-center gap-8" >
      ...
      <div className="backdrop-blur-sm py-2 w-fit justify-self-center rounded-full border border-white/40  px-24 flex justify-center">
        <span className="text-sm  tracking-wide">Engineered for a New Standard</span>
      </div>
    ...
    <div className="grid gap-4">
       ...
       <BlurText
  text="The Partner We Wanted. So We Built It."
  delay={150}
  animateBy="words"
  direction="top"
...
/> */}
    ...
    >
      ...
      >
       Frustrated by slow, inconsistent support, we created a new global standard built on elite engineering, radical reliability, and an obsessive focus on client outcomes.
      </motion.p>
