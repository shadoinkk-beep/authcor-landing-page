...
{/* <!-- Job Cards Section --> */}
<div className="max-w-7xl mx-auto grid gap-6 px-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
  ...
  <div className="bg-white shadow-lg rounded-lg p-6 border grid">
    ...
    <button onClick={()=>{setapplydisplay(true)}} className="w-full bg-red-600 font-semibold text-white py-2 px-4 rounded-md hover:bg-red-600 self-end h-fit hover:bg-white hover:text-black border-2 border-red-600">Apply here</button>
  </div>
